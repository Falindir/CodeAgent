...
LILI.Collections.List = Class.extend({
  ...
  getAllIndex : function (value) {
    var index = LILI.Collections.List.create();
  ...
  getInterval : function (start, end) {
    var interval = LILI.Collections.List.create();
...
LILI.Collections.Map = Class.extend({
  ...
  init : function() {
    this.keys = LILI.Collections.List.create();
    this.values = LILI.Collections.List.create();
    this.size = 0;
  },
